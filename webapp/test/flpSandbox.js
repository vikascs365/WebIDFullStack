		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "First app on full stack",
									"targetURL": "#Firstapponfullstack-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Firstapponfullstack-display": {
								"semanticObject": "Firstapponfullstack",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zvcs.demo.firstapponfullstack",
									"url": sap.ui.require.toUrl("zvcs/demo/firstapponfullstack")
								}
							}
						}
					}
